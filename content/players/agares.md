...
Agares is a member of the party and a cleric. He possesses divine sensitivities and heightened perceptions that allow him to detect supernatural presence and spiritual disturbances. He is protective of the party's interests and alert to threats in their environment.
...
### Session 10
Intervened in combat with [Count Strahd von Zarovich]({{< ref "/npcs/strahd-von-zarovich" >}}) to protect [Pepino Falstaff]({{< ref "/players/pepino-falstaff" >}}) from being grabbed by the vampire. Assigned duty to watch the back door of the inn during the night. Appears in [Session 10]({{< ref "/sessions/session-10" >}}).
