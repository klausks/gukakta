...
subtitle: "Winery Supplying Vallaki"
date: 2026-03-07
draft: false
tags: ["location", "winery", "vallaki"]
summary_box: |
  **Region:** Barovia (exact region unknown)  
  **Travel Time:** ~8 hours from [Vallaki]({{< ref "/locations/vallaki" >}})  
  **Known For:** Wine production and deliveries to Vallaki
---

## Overview

The Wizard of Wines Winery is a winery operated by Urwin Martikov's family. Wine has been in short supply in Vallaki for weeks, and Urwin claims the disruption is not due to natural causes.

He suspects druids and corrupted creatures may be involved, possibly under the influence of Strahd.
...
### Session 31
Urwin asked the party to travel to the winery and investigate why deliveries have been failing for weeks, noting the location is roughly eight hours from Vallaki. Appears in [Session 31]({{< ref "/sessions/session-31" >}}).
...
### Session 45
The party encounters [the winery druid]({{< ref "/npcs/the-winery-druid" >}}) and incapacitates them. While exploring the basement, [Jimmy Slit]({{< ref "/players/jimmy-slit" >}}) discovers a hidden chamber concealed behind a movable bookshelf. Within, the party overhears a conversation between [Swigas]({{< ref "/npcs/swigas" >}}) and [Rahadin]({{< ref "/npcs/rahadin" >}}). A magical portal opens and closes, allowing [Igga Bevneros]({{< ref "/players/igga-bevneros" >}}) and [Monel]({{< ref "/players/monel" >}}) to follow Rahadin and Swigas into the portal, while the rest of the party remains behind. Appears in [Session 45]({{< ref "/sessions/session-45" >}}).

### Session 47
The party was unable to remove the green gem from the druid's staff. The Martikovs agreed to hold the staff and gem until the party can return. [Jimmy Slit]({{< ref "/players/jimmy-slit" >}}) collected the rewards. [Davian Martikov]({{< ref "/npcs/davian-martikov" >}}) and the rest of the Martikov family arrived and thanked the party. The remaining part of the group recited the poem from *[Wines of Barovia]({{< ref "/lore/wines-of-barovia" >}})* to open the portal and stepped through, emerging in the attic of the [Baron's Mansion]({{< ref "/locations/baron-mansion-vallaki" >}}) in Vallaki. Appears in [Session 47]({{< ref "/sessions/session-47" >}}).
